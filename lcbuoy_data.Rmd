...
```{r valcour_watertemp_degF, out.width = "100%"}
valcour_watertemp_plot_degF <- valcour_watertemp %>%
  ggplot() +
...
ggplotly(valcour_watertemp_plot_degF)
```
### In degrees Celsius
```{r valcour_watertemp_degC, out.width = "100%"}
valcour_watertemp_plot_degC <- valcour_watertemp %>%
  ggplot() +
  geom_tile(aes(x = timestamp,
                y = depth_m,
                fill = degC)) +
...
ggplotly(valcour_watertemp_plot_degC)
```
